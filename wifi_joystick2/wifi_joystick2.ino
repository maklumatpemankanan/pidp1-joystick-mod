/*
improved wifi joystick device for the pidp1 computer replica
v2.0 
you can change the bit-postions of the joystick-directions in the joystick.h-file

(c) 2025 by matthias barthel | https://github.com/maklumatpemankanan/pidp1-joystick-mod
*/
...
void setup() {
  Serial.begin(115200);
  delay(500);
  Serial.println("PDP-1 Joystick-controller v2");
  // Connect to WiFi
...
void handleInputDevice(uint8_t device_id, uint8_t* packet) {
  ...
  uint32_t io_value = Joysticks_read();

  //Serial.print("Joystick-value : ");
  //Serial.println(io_value, BIN);
